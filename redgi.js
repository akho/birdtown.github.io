...
const TextNodes = [
    {id: 1,
        text: async () => `Добро пожаловать в игру "Птицбург"! На прохождение игры вам потребуется от 2 до 15 минут в зависимости от выбранного вами пути. У этой игры 10 концовок, поэтому крайне рекомендую пройти ее несколько раз по-разному!`,
        image: 'location0.jpg',
    ...
    {id:16,
        text: async () =>'Реджинальд вернулся в клуб "Пташка" и рассказал Валентину о своей ситуации. Валентин, внимательно выслушав, предложил дать Реджи одно дельце за небольшие деньги, чтобы проверить его способности! В соседнем городке один скат по имени Скотт кое-что задолжал Валентину',
        image: 'location3.jpg',
    ...
    {id:20, 
        text: async () => 'Пробежав несколько районов, птицы остановились. Реджи упал на землю без сил, пока Арчибальд расхаживал туда-сюда. "Спасибо, Реджи! Я этого никогда не забуду! А из хороших новостей: я успел забрать этот конверт! Валентин будет доволен. А почему ты приехал сюда, Реджи?"',
    ...
    {id:21, 
        text: async () => 'Реджи обратился к Арчибальду: "Арчи, я провалил вступительные и теперь мне нужна работа" - "Провалил? Эх, блин, ну ничего, в следующий раз повезет! Ты умный птенчик! Помогу тебе вообще без проблем, есть несколько идей! Выбирай сам"',
        image: 'location13.jpg',
        player_image: 'player2.png',   
        options: [
            {
    ...
    {id:26, 
        text: async () => 'Эми улыбнулась, и ее глаза засияли еще ярче. "Я знаю, посмотрела всех одногруппников в птицаграмме, было интересно! Ты только ничего плохого не подумай!" В аудиторию зашел профессор.',
        image: 'location16.jpg',
        player_image: 'player13.png',   
        options: [
            {
    ...
    {id:27, 
        text: async () => '"Всем добрый день! Я профессор Пауль, это мой аспирант Пауль Джуниор, и сегодня мы начнем изучение низкоуровневых языков программирования!"',
        image: 'location16.jpg',
    ...
    {id:35, 
        ...
        options: [
            ...
            {
                text: async () => 'Поцеловать Эми и полететь домой ботать и кодить',
                requiredState: (currentState) => currentState.stypendy,
                nextText: 55
            }
            ,
    ...
    {id:36, 
        text: async () => 'Реджи приехал на виллу Скворца Сергея, главного бизнес-цыпана этого города, на семинар по марафону успеха. В конференц-зале собралось множество щебечущих птичек со всего города. Реджи занял свободное место на заднем ряду. Неожиданно в зале погас свет, заиграла торжественная музыка, и Скворец под громкие апплодисменты зашел в зал и встал у экрана.', 
    ...
    {id:38, 
        text: async () => 'Акции ЦыпПрома казались крайне притягательной инвестицией, исходя из информации на слайдах. Однако Реджи сильно сомневался. К птичкам стали подходить советники Скворца Сергея и настойчиво предлагать покупку акций. Началась суета.', 
        image: 'location18.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:39, 
        text: async () => 'Реджи вернулся домой, а через пару дней он узнал, что акции компании ПтицПрома обесценились, а инфоцыпан Скворец Сергей, применив мошенническую схему, оставил всех птичек с клювом. Доверяй после такого скворцам или сергеям, - подумал Реджи.', 
        image: 'location15.jpg',
        player_image: 'player21.png',   
        options: [
            {
    ...
    {id:41, 
        ...
        options: [
            {
                text: async () => 'Использовать информацию про ПтицПром и отнять часть заработка у инфо-цыпана',
                nextText: 42
    ...
    {id:43, 
        text: async () => 'Реджи под выдуманным именем зарегистрировался еще на один семинар, чтобы собрать необходимую информацию. Рядом с ним села компания молоденьких пташек. Реджи задумался.', 
        image: 'location15.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:52, 
        text: async () => 'Реджинальд закрыл всю сессию на отлично и был номинирован на студент года! Профессор Пауль порекоммендовал его и Эми на стажировку в ВКурятнике.', 
        image: 'location5.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:53, 
        text: async () => 'Спустя несколько птичьих лет. Реджинальд выпустился с красным дипломом из Птицбургского Государственного Университета и получил очередное повышение в ВКурятнике.', 
        image: 'location5.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:55, 
        text: async () => 'Реджинальд отчаянно кодил и ботал долгое время! И теперь готов покорить сессию!', 
        image: 'location15.jpg',
        player_image: 'player8.png',   
        options: [
            {
    ...
    {id:56, 
        text: async () => 'Реджи долго и упорно корпел над учебой! И благодаря своей целеустремленности смог пересдать сессию и впоследствии заполучить звание студент года! Он долго и упорно проходил собеседования и получил долгожданное приглашение на стажировку ВКурятнике!', 
        image: 'location15.jpg',
        player_image: 'player8.png',   
        options: [
            {
    ...
    {id:57, 
        text: async () => 'Рынок непредсказуем, но Реджи повезло и он смог заработать на акциях ВКурятнике. Однако он был мудрым птицем и не стал считать удачное стечение обстоятельств подходящей стратегией, поэтому продолжил писать алго-стратегии.', 
        image: 'location7.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:58, 
        text: async () => 'Рынок непредсказуем, и Реджи потерял на акциях ВКурятнике. Однако он был мудрым птицем и не стал отчаиваться, поэтому продолжил писать алго-стратегии.', 
        image: 'location7.jpg',
        player_image: 'player21.png',   
        options: [
            {
    ...
    {id:59, 
        text: async () => 'Рынок непредсказуем, акции ВКурятнике сильно выросли в цене, и Реджи потерял возможную прибыль. Однако он был мудрым птицем и не стал отчаиваться, поэтому продолжил писать алго-стратегии.', 
        image: 'location7.jpg',
        player_image: 'player21.png',   
        options: [
            {
    ...
    {id:60, 
        text: async () => 'Рынок непредсказуем, и акции ВКурятнике сильно упали. Реджи чудом отказался от вкладывания своих средств в них. Однако он был мудрым птицем и не стал считать удачное стечение обстоятельств подходящей стратегией, поэтому продолжил писать алго-стратегии.', 
        image: 'location7.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:61, 
        text: async () => 'Спустя несколько лет Реджи сколотил огромное состояние и решил купить собственную виллу! В пути на просмотр дома он решил позвонить своим друзьям и позвать их с собой!', 
        image: 'location8.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:62, 
        text: async () => 'Трубку взял крайне обеспокоенный Арчи, он извинился и сказал, что не сможет сейчас никуда подъехать. Реджи заволновался и спросил "Арчи, все в порядке?" - "Нет, мне стыдно признаться, но нет, я задолжал очень большную сумму, я должен 20 миллионов. И я не знаю, где их достать"', 
        image: 'location8.jpg',
        player_image: 'player1.png',   
        options: [
            {
                text: async () => '"Кому ты задолжал, Арчи? Может надо пойти в полицию?"',
                nextText: 63
            }                                 
        ]     
    }, 
    {id:63, 
        text: async () => '"Нет, только не полиция! Это будет конец" Реджи некоторое время подумал. "Хорошо, давай я одолжу тебе эту сумму" - "Ты серьезно?" - "Абсолютно, сейчас все переведу, а ты обязательно приезжай в гости" - "Да, конечно, Реджи, спасибо, ты спас мне жизнь"', 
        image: 'location8.jpg',
        player_image: 'player1.png',   
        options: [
            {
            ...
            {
                text: async () => 'Перевести деньги Арчи и позвонить пригласить Эми',
    ...
    {id:64, 
        text: async () => 'Эми с Реджи выбрали прекрасную виллу, после чего Реджи ее купил! Они быстро накрыли стол и стали ждать Арчи!', 
        image: 'location9.jpg',
        player_image: 'player23.png',   
        options: [
    ...
    {id:65, 
        text: async () => 'Реджи выбрал прекрасную виллу, после чего ее купил! Он быстро накрыл стол и стал ждать Арчи!', 
        image: 'location9.jpg',
        player_image: 'player1.png',   
        options: [
    ...
    {id:66, 
        text: async () => 'Раздался звонок в дверь: Реджи встретил улыбающегося Арчи. И весь оставшийся вечер прошел под гул музыки, звон бокалов и радостных возгласов в честь покупки первой недвижимости!', 
        image: 'location9.jpg',
        player_image: 'player24.png',   
        options: [
    ...
    {id:67, 
        text: async () => 'С утра Реджи проснулся с улыбкой, несмотря на головную боль. Неожиданно раздался звонок. Обеспокоенный Реджи поднял трубку. "Реджинальд, вас беспокоит налоговая. Мы видим несоответствие, хотим пригласить вас на разговор"', 
        image: 'location9.jpg',
        player_image: 'player9.png',   
        options: [
            {
                text: async () => 'Поехать в налоговую и уплатить все просроченные налоги',
                requiredState: (currentState) => currentState.Amyhate,
                nextText: 69
            },
            {
    ...
    {id:71, 
        text: async () => 'Реджи и Эми вышли на должность senior программистов ВКурятнике и приступили к разработке встроенных птичьих игр.', 
    ...
    {id:72, 
        text: async () => 'Неожиданно раздался звонок от Арчи. "Реджи, Реджи, я в огромной беде, я задолжал 20 миллионов. Помоги мне, пожалуйста" - "Арчи, у меня нет такой суммы, что можно сделать еще?" - "Не знаю". Звонок оборвался. На работе сегодня была очень важная презентация. Реджи знал, если он не пойдет туда, его сразу уволят.', 
        image: 'location20.jpg',
        player_image: 'player1.png',   
        options: [

            {
                text: async () => 'Попросить Эми прикрыть на работе и побежать искать Арчи',
                requiredState: (currentState) => currentState.Amyfriend,
                nextText: 74
            },
            {
    ...
    {id:74, 
        text: async () => 'Встревоженный Реджи прибежал в дом Арчи. Дома никого не было. Он начал искать повсюду подсказки. Неожиданно раздался звонок в дверь.', 
    ...
    {id:75, 
        text: async () => 'У двери стоял бегемот. "А вы кто?" - "А вы кто?" - "Я Персик, детектив, хочу увидеть Арчибальда" - "Я Реджинальд, друг Арчибальда, Арчи пропал" - "Хммм, дело осложняется" - "О чем вы?" - "Нам лучше зайти внутрь и поговорить наедине"', 
        image: 'location21.jpg',
        player_image: 'player26.png',   
        options: [

            {
                text: async () => '"Да, конечно". Впустить детектива Персика внутрь',
                nextText: 76
            }                                             
        ]     
    }, 
    {id:76, 
        text: async () => '"Не хочу вас пугать, Реджинальд, но дела плохи" - "Что с Арчи?" - "Он попал не в ту компанию. Я надеялся решить эту проблему через полицию, однако мне дали понять, что это невозможно."', 
        image: 'location21.jpg',
        player_image: 'player27.png',   
        options: [

            {
                text: async () => '"Что? О чем вы говорите? А вы не из полиции? Вы же детектив!"',
                nextText: 77
            }                                             
        ]     
    }, 
    {id:77, 
        text: async () => '"Уже нет, я частный детектив. Арчибальд нанял меня, почуяв неладное. Он знал, что в Птицбурге и Океанвилле нет смысла искать спасения. Поэтому позвонил мне." - "Океанвилль? Он здесь при чем? Это просто городок рядом" - "Для обывателей да, но некоторые их жители пустили свои щупальца в Птицбург. Но это совсемя другая история"', 
        image: 'location21.jpg',
        player_image: 'player27.png',   
        options: [
    ...
    {id:78, 
        text: async () => '"Арчибальд недавно приобрел булочную недалеко от Птицбургского Государственного Университета, деньги на нее он взял, к сожалению, не в банке, а у одного авторитета" - "О господи" - "Да, полагаю возникили проблемы. Нам нужно замаскироваться и пробраться в булочную"', 
        image: 'location21.jpg',
        player_image: 'player27.png',   
        options: [
    ...
    {id:79, 
        text: async () => 'Ночью Персик и Реджи пробрались в булочную. Весь пол был усыпан голубиными перьями. По спине Реджи пробежал холодок. Детектив: "Следы свежие, они были здесь совсем недавно, мы еще можем успеть"', 
        image: 'location14.jpg',
        player_image: 'player28.png',   
        options: [
    ...
    {id:80, 
        text: async () => 'Персик и Реджи выбежали на улицу через черный ход и направились к улице. Неожиданно в районе мусорки послышалось шуршание. Детектив, достав пистолет, направился к контейнерам. Персик крикнул: "Выходи с поднятыми руками". Шорох усилился, мешки с мусором зашевелились, и перед Персик и Реджи неожиданно возник...', 
    ...
    {id:81, 
        text: async () => '"Арчи!Ты жив!" - "Да, Реджи, жив, но ненадолго, я влез в такую авантюру. Добрый вечер, детектив!" Персик неопределенно хмыкнул и сказал "Главное - вы живы, насчет остального: я все проверил, к сожалению, решить эту ситуацию в вашу пользу не получится". Арчи грустно вздохнул "Я понял, детектив, спасибо вам за все! Дальше мы сами" Персик кивнул, попрощался и ушел.', 
        image: 'location22.jpg',
        player_image: 'player30.png',   
        options: [
    ...
    {id:82, 
        text: async () => '"Арчи!" - "Боюсь, Реджи, мне придется покинуть город. Я неудачно провел одну бизнес-операцию с голубем Валентином и теперь мне нужно возместить ему потери, 20 миллионов" - "Откуда такая сумма?" - "Я должен был ему долю булочек по вечерам, но я все распродал и пришлось отдать ему плесневелые батоны"', 
        image: 'location22.jpg',
        player_image: 'player29.png',   
        options: [
    ...
    {id:83, 
        text: async () => '"Но я слышал, что голуби любят плесневелые батоны, они...наркоманы" - "Да, но в этот раз заказ был не для голубей, я сильно подставил Валентина. Делать нечего, либо деньги, либо срочно покинуть Птицбург, подождать пока все уляжется. Ты со мной, Реджи?"', 
        image: 'location22.jpg',
        player_image: 'player29.png',   
        options: [

            {
                text: async () => '"Арчи, я слышал, что у моей подруги влиятельный и богатый отец. Может он одолжит нам деньги под процент"',
                requiredState: (currentState) => currentState.Amyfriend,
                nextText: 84
            },
            {
                text: async () => '"Конечно, Арчи, лучше дома у тебя больше не появляться. Зайдем ко мне, соберем вещи и поедем. В ближайшее время в Птицбурге нам делать нечего."',
                requiredState: (currentState) => currentState.Amyhate,
                nextText: 85
            }                                         
        ]     
    ...
    {id:86, 
        text: async () => 'Реджинальд устроился в ПтицТакси и начал работу. Первым клиентом оказался крайне взбалмошный, самовлюбленный Щегол по имени Святослав, который всю дорогу рассказывал о миллионе своих бизнесов и своем невероятном успехе. В какой-то момент он спросил Реджи про его работу.', 
        image: 'location29.jpg',
        player_image: 'player1.png',   
        options: [

            {
                text: async () => 'Сказать "Вообще я тоже бизнесмен, а такси это так, для души"',
                nextText: 87
            }                                             
        ]     
    }, 
    {id:87, 
        text: async () => 'Реджинальд высадил в конечной точке Щегола и поехал в сторону дома. Неожиданно ему пришел заказ и появилась необходимость развернуться. Можно ли выполнить тут разворот?', 
    ...
    {id:88, 
        text: async () => 'Реджи нарушил правила, его сразу остановили птицы автоинспекции и оштрафовали. Реджи решил повторить все правила дорожного движения, чтобы больше не попадать в такие ситуации!', 
        image: 'location29.jpg',
        player_image: 'player9.png',   
        options: [

            {
                text: async () => 'Повторить правила дорожного движения и продолжить работу!',
                nextText: 91
            }                                             
        ]     
    }, 
    {id:89, 
        text: async () => 'Реджи нарушил правила, однако, к счастью, птицы автоинспекции не заметили этого и не оштрафовали бедняжку. Реджи решил повторить все правила дорожного движения, чтобы больше не попадать в такие ситуации!', 
        image: 'location29.jpg',
        player_image: 'player1.png',   
        options: [
    ...
    {id:89, 
        text: async () => 'Реджи хорошо знал правила дорожного движения, поэтому не стал разворачиваться в этом месте! Какой умный птиц!', 
        image: 'location29.jpg',
        player_image: 'player1.png',   
        options: [
    ...
    {id:91, 
        text: async () => 'Реджи работал в такси уже некоторое время, он смог выплатить Арчи свой долг и начал копить на курсы по программированию. Однажды поздно вечером ему пришел новый заказ. Его клиентом оказалась милая птичка по имени Эми.', 
    ...
    {id:92, 
        text: async () => 'Реджи и Эми мило пообщались в пути, она ему очень понравилась. Он подвез ее к дому и попрощался. Эми вышла из машины и направилась к подъезду.', 
        image: 'location26.jpg',
        player_image: 'player23.png',   
        options: [

            {
                text: async () => 'Нажать в приложении ПтицТакси "Окончание заказа"',
                nextText: 93
            }                                             
        ]     
    }, 
    {id:93, 
        text: async () => 'Неожиданно прямо у подъезда на Эми напали гоп-голуби, они хотели украсть ее сумочку. Эми отчаянно сопротивлялась и кричала.', 
        image: 'location27.jpg',
        player_image: 'player17.png',   
        options: [
            {
    ...
    {id:94, 
        text: async () => 'Реджи побежал спасать Эми. Он изо всех своих птичьих сил дрался с гоп-голубями, однако все равно был сильно избит. Эми пригласила его в дом, чтобы обработать его раны. "Огромное спасибо тебе, птиц! Ты спас мне жизнь"', 
        image: 'location27.jpg',
        player_image: 'player23.png',   
        options: [
            {
                text: async () => 'Глупо улыбаться, несмотря на боль во всем теле',
                nextText: 95
            }                                                  
        ]     
    },
    {id:95, 
        text: async () => 'Реджи рассказал Эми о том, что почти накопил на курсы программиста и собирается пойти работать в IT-компанию. Эми похвалила его начинания и сказала, что она работает middle программистом ВКурятнике и скоро ее ждет повышение. Она пообещала, что как только Реджи закончит курсы, она сразу его порекоммендует в команду.', 
    ...
    {id:96, 
        text: async () => 'Напоив Реджи чаем, Эми оставила его спать на диване. А с утра, провожая его, сказала: "Не хочу выглядеть чрезмерно настойчивой, но хотела бы вознаградить моего героя и позвать тебя на летнее кино на набережной сегодня. Только если ты хочешь"', 
        image: 'location28.jpg',
        player_image: 'player23.png',   
        options: [
            {
    ...
    {id:97, 
        text: async () => 'Реджи продолжал активно работать таксистом и накопил нужную сумму для курсов по программированию. Уже сегодня он собирался внести оплату за обучение! Неожиданно ему поступил новый заказ.', 
        image: 'location29.jpg',
        player_image: 'player1.png',   
        options: [
            {
    ...
    {id:98, 
        text: async () => 'В машину к Реджи сели два очень тревожных птица. Одному из них было очень плохо. Реджи узнал его, это был знаменитый гонщик Формулы 1, Орел Михаэль Бердмахер. Он крикнул "В больницу! Умоляю! Быстрее" Второй птиц похлопал Реджи по плечу и сказал "Любые деньги, только быстрее, у него разорвался птиц аппендикс"', 
        image: 'location29.jpg',
        player_image: 'player9.png',   
        options: [
            {
    ...
    {id:99, 
        text: async () => 'Реджи с огромной скоростью вез бедного птица в больницу и все-таки успел! Жизнь знаменитого гонщика была вне опасности. Второй птиц подошел к Реджи: "Спасибо тебе, даже не знаю как тебя отблагодарить, я менеджер Бердмахера, ты спас его жизнь. Я знаю, что не вправе просить тебя о чем-то большем, но все же, хочу попробовать"', 
    ...
    {id:100, 
        text: async () => '"Михаэль нескоро придет в себя, а завтра гонка. Я видел, как ты водишь, ты очень крутой птиц. Я хочу предложить тебе работу! Ты согласен?"',
        image: 'location30.jpg',
        player_image: 'player1.png',   
        options: [
            {
                text: async () => 'Отказаться и пойти по намеченному пути: курсы программиста и рекоммендации Эми',
                requiredState: (currentState) => currentState.Amyfriend,
                nextText: 101
            },       
            {
    ...
    {id:101, 
        text: async () => 'Реджинальд отказался от возможности стать гонщиком и этим же вечером поступил на курсы программиста. Отучившись с невероятным успехом, он натренировался для собеседований и, воспользовавшись рекоммендации Эми, заполучил сразу высокую должность ВКурятнике.',
        image: 'location15.jpg',
        player_image: 'player8.png',   
        options: [
    ...
    {id:102, 
        text: async () => 'Реджинальд согласился на эту невероятно авантюрную затею и на следующий день пришел на стадион.',
    ...
    {id:103, 
        text: async () => 'Несмотря на огромное волнение, Реджи смог выиграть в гонке и получил свой первый гонорар! С ним сразу подписали контракт! Счастливый Реджи направлялся домой, как раздался телефонный звонок от Арчи.',
        image: 'location31.jpg',
        player_image: 'player1.png',   
        options: [
    ...
    {id:104, 
        text: async () => '"Реджи, мне стыдно признаться, но я в огромной беде, только не говори полиции. Я должен 20 миллионов страшному птицу. Это конец" - "Арчи, объясни что случилось" - "Это не телефонный разговор, наверное, мне надо уехать из города" - "Я дам тебе эти деньги, сегодня же вечером встретимся" - "О боже, Реджи, ты спас мою жизнь"',
        image: 'location31.jpg',
        player_image: 'player1.png',   
        options: [
    
            {
                text: async () => 'Перевести Арчи весь заработанный гонорар и встретиться с ним вечером',
                nextText: 105
            }                                                  
        ]     
    }, 
    {id:105, 
        text: async () => 'Реджи встретился дома у Арчи этим же вечером. И Арчи слезно поблагодарив друга, все ему рассказал: как занял деньги у голубя Валентина на булочную, как совершил ошибку, как благодаря Реджи смог спасти свои перышки и решил завязать с преступным миром. Реджи задумался."Арчи, а ты не хочешь стать моим менеджером? Я теперь гонщик" - "Правда? Я с огромным удовольствием"',
        image: 'location21.jpg',
        player_image: 'player24.png',   
        options: [
    ...
    {id:108, 
        text: async () => 'Реджи и Арчи отправились в клуб "Пташка", чтобы получить задание от Валентина. Валентин, внимательно осмотрев птичек, приказал им сесть рядом и начал свой рассказ. "Я думаю, ни для кого здесь не секрет, что голуби держут большую часть преступного мира Птицбурга, однако недавно у нас появились конкуренты"',
        image: 'location4.jpg',
        player_image: 'player7.png',   
        options: [
    ...
    {id:109, 
        text: async () => 'Валентин продолжал "Есть много разных бизнесов, которые я не собираюсь прибирать к своим крыльям, но есть те, поводья которых я предпочитаю держать крепко-накрепко" Окружающие его голуби загоготали, видимо, любое высказывание Валентина автоматически казалось им остроумным.',
        image: 'location4.jpg',
        player_image: 'player6.png',   
        options: [
    
            {
                text: async () => '"О каком бизнесе мы говорим сейчас?" Спросил Реджи',
                nextText: 110
            }                                                  
        ]     
    }, 
    {id:110, 
        text: async () => '"Сразу к делу, мне нравится твой подход, птиц. Меня интересует семечковый бизнес. Я раньше контролировал поставки семечек в Птицбург, но с недавних пор, ни один из моих поставщиков не хочет со мной сотрудничать. Есть кто-то, кого они сильно боятся. И я хочу узнать кто это. Я бы отправил своих ребят, но вы сами видите: интеллект и аккуратность - это не их сильаня сторона"',
        image: 'location4.jpg',
        player_image: 'player6.png',   
        options: [
    ...
    {id:111, 
        text: async () => '"Последняя зацепка находится в Океанвилле, скат по имени Скотт имел неосторожность проиграть мне в карты один документ. Отдал он его не сразу, но Арчибальд с этим делом помог. Это для начала. Я хочу, чтобы вы узнали, кто за всем этим делом стоит и назвали мне его имя."',
        image: 'location4.jpg',
        player_image: 'player7.png',   
        options: [
    ...
    {id:112, 
        text: async () => '"Что будем делать, Реджи?" - "Для начала изучим документ Скотта, а оттуда будем двигаться" - "Логично, что ж, пойдем ко мне домой, документы лежат там"',
        image: 'location13.jpg',
        player_image: 'player24.png',   
        options: [
    ...
    {id:114, 
        text: async () => 'Проверив ее соцсети, птенчики так ничего и не нашли. "Вроде просто красивая пташка, учится в Птицбургском Государственном Университете, ничего непонятно" - "Судя по записке, нам нужен ее отец, а не она сама" - "Что делать?" - "Может попробуем поймать ее у университета?" - "Давай"',
        image: 'location21.jpg',
        player_image: 'player24.png',   
        options: [
    ...
    {id:116, 
        text: async () => '"Слышала, а что? Вы его птички на привязи?" с подозрением спросила Эми. Реджи вздохнул "Можно и так сказать, мы никакого зла тебя не желаем, ты не подумай, мы просто кое-кого ищем" - "Кого?" - "Сами не знаем" - "И почему я должна вам помогать?" - "Не знаю, глупо вышло, прости" - "Вы вроде неплохие птицы, зачем вы на него работаете?"',
        image: 'location5.jpg',
        player_image: 'player13.png',   
        options: [
    ...
    {id:117, 
        text: async () => '"Понятно, я не могу ничего обещать, но выслушать вас точно могу, однако не здесь, пойдемте в булочную, она тут рядом"',
        image: 'location5.jpg',
        player_image: 'player13.png',   
        options: [
    ...
    {id:118, 
        text: async () => '"А теперь давайте по порядку" Пташки рассказали Эми все. Она задумалась. "Получается, этот Скотт хотел через меня выйти на моего отца, хмм, и это все касается семечек. Прошу прощения, мне надо сделать телефонный звонок"',
        image: 'location14.jpg',
        player_image: 'player13.png',   
        options: [
    ...
    {id:119, 
        text: async () => '"Реджи,а вдруг она сейчас нас сдаст" - "Мне кажется, ей можно доверять" - "Я вижу, как ты на нее смотришь, ты влюбился, но, пожалуйста, включи разум, мы не знаем, кто она такая, а главное - кто ее отец" - "В этом ты прав, но отступать некуда"',
        image: 'location14.jpg',
        player_image: 'player24.png',   
        options: [
    ...
    {id:120, 
        text: async () => 'Неожиданно к булочной подъехад полностью затонированный джип. Эми вышла на улицу и села в него. Казалось, прошла целая вечность. Арчи: "Реджи, давай просто убежим через задний вход и уедем в другой город, я что-то боюсь"',
    ...
    {id:121, 
        text: async () => 'Реджи с Арчи незаметно выскользнули через черный ход булочной и галопом побежали домой собирать вещи!',
        image: 'location22.jpg',
        player_image: 'player24.png',   
        options: [
    ...
    {id:122, 
        text: async () => 'Спустя некоторое время Эми вышла из машины и, снова зайдя в булочную, села рядом с ребятами. "Дела обстоят следующим образом, вам следует съездить в Океанвилль и вновь поговорить со Скоттом, он будет гораздо более разговорчив в этот раз" - "Спасибо, Эми" - "Пока не за что, я вот что вам скажу, я не советую работать вам на Валентина, он любит искажать факты и обманывать. Рано или поздно он вас подставит"',
        image: 'location14.jpg',
        player_image: 'player13.png',   
        options: [
    
            {
                text: async () => 'Реджи тяжело вздохнул "Понятно, в любом случае спасибо, мы учтем твое предупреждение"',
                nextText: 123
            }                                                  
        ]     
    },
    {id:123, 
        text: async () => 'Эми кивнула и загадочно улыбнулась "Что ж, удачи вам, птенчики, думаю, мы еще увидимся" Реджинальд встал и в порыве чувств ее обнял "Ой, боже, прости, я просто очень благодарен" - "Ну ничего, ничего, все будет хорошо". Эми еще раз улыбнулась, вышла из булочной и села в джип.',
        image: 'location14.jpg',
        player_image: 'player23.png',   
        options: [
    ...
    {id:125, 
        text: async () => '"Так что? Вы ему все объясните?" - "Попробуем, а теперь к делу". Арчи с Реджи переглянулись, они и представить не могли, насколько сильно они увязли. "Так вот, мой бывший заказчик очень захотел долю в семечковом бизнесе, но это птичья территория, все знают, голубь Валентин всегда хотел ее держать при себе." - "Кто твой бывший заказчик?" - "Обо всем по порядку, лучше присядьте"',
        image: 'location12.jpg',
        player_image: 'player32.png',   
        options: [
    ...
    {id:127, 
        text: async () => '"Остаток истории вы и так знаете, Валентин решил использовать мою слабость за карточным столом, он шулер, но я повелся и очень виноват. У меня была информация, которая должна была помочь моему заказчику выйти на Бескрылого, я должен был передать ему ее в тот день." - "Кто твой заказчик?" - "В Птицбурге его знают как Пауль Джуниор, аспирант одного профессора в Птицбургском Государственном Университете"',
        image: 'location12.jpg',
        player_image: 'player32.png',   
        options: [
    ...
    {id:129, 
        text: async () => '"Что думаешь, Арчи?" - "Что дело сделано, можно занять денег у Валетина и выкупить ту булочную у университета, уж очень она мне понравилась!" - "Нет, Арчи, это плохая идея, все они правы, работа на Валентина небезопасна. Мы завершим это дело и выйдем из его игры" - "А дальше что, Реджи? Уехать в никуда, все бросить?"',
        image: 'location13.jpg',
        player_image: 'player24.png',   
        options: [
            ...
            {
                text: async () => '"Подняться с 0 и стать криминальными лордами Птицбурга"',
                nextText: 130
            }                                                             
        ]     
    },
