...
const TextNodes = [
    {id: 1,
     text: async () => {
         ...
         return `Добро пожаловать в игру "${json.title}"! На прохождение игры вам потребуется от 2 до 15 минут в зависимости от выбранного вами пути. У этой игры много концовок, поэтому крайне рекомендую пройти ее несколько раз по-разному!`;
     },
        image: 'location0.jpg',
    ...
    {id:15,
        text: async () => 'Реджи вернулся к своим родителям, отказавшись от мечты покорить Птицбург!',
